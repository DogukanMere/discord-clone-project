...
const Header = (props: Props) => {
  return (
    <>
      <div className='bg-hero overflow-hidden w-full'>
        {/* Navbar */}
        <Navbar />
      </div>
      <div className='bg-hero min-h-[546px] relative overflow-hidden w-full md:pb-[80px] lg:pb-0'>
        {/* Text + Button */}
        <div className='w-full z-[5] px-[24px] md:px-[40px] py-[56px] md:py-[80px] text-white md:w-[70%] lg:w-full lg:flex lg:flex-col lg:text-center lg:max-w-[780px] lg:m-auto'>
          ...
          <div className='z-[7] flex md:flex-col flex-wrap justify-start lg:justify-center lg:flex-row'>
            <Link
              href='#'
              className='flex items-center w-fit justify-center text-primary text-[18px] font-medium space-x-2 mt-[24px] mr-[24px] px-[32px] py-[16px] bg-white rounded-full hover:shadow-xl hover:text-hero transition-all duration-300'
            >
            ...
            <Link
              href='#'
              className='flex md:block items-center w-fit justify-center text-white text-[18px] font-medium space-x-2 mt-[24px] px-[32px] py-[16px] bg-primary rounded-full hover:shadow-xl hover:bg-[#35383e] transition-all duration-300'
            >
        ...
        {/* Images */}
        <div className='relative select-none md:absolute md:top-0 md:left-0 md:h-full md:w-full md:pt-[2rem]'>
          <img
            src='/img/hero1.svg'
            alt='hero image'
